    ...
    <main className="workbench">
      ...
      <section className="review-grid">
        ...
        <div className="review-panel">
          ...
          <Reasoning item={item} review={review} saveReview={saveReview} datasetVersion={datasetVersion} />
        </div>
      </section>
